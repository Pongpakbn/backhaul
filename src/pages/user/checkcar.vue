  ...
  export default {
    data () {
      return {
        ...
        vehicleTypes: [
          'รถ 4 ล้อ (ตู้ทึบ)', 'รถ 6 ล้อ (ตู้ทึบปกติ)', 'รถ 6 ล้อ (ตู้ทึบช่วงยาว)', 'รถ 10 ล้อ (คอก+ผ้าใบ)',
          'รถ 10 ล้อ (ตู้ทึบต่อเอง)', 'รถ 10 ล้อ (คอนเทนเนอร์ตู้สั้น)', 'พ่วงแม่ลูก แบบ 6 ล้อ (ตู้ทึบ)', 'พ่วงแม่ลูก แบบ 6 ล้อ (คอก+ผ้าใบ)',
          'พ่วงแม่ลูก แบบ 10 ล้อ (ตู้ทึบ)', 'พ่วงแม่ลูก แบบ 10 ล้อ (คอก+ผ้าใบ)', 'พ่วงแม่ลูก แบบ 10 ล้อ (ตู้สั้น 2TEU)', 'รถกึ่งพ่วง (หัวลากตู้ยาว)',
        ],
